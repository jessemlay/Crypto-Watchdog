...
/**
 * Checks if the current platform version is greater than or
equal to the desired minimum version given
 *
 * @param minimumVersion {string} E.g. 10.0.0.
 * See [the Darwin operating system Wikipedia entry](http://
en.wikipedia.org/wiki/Darwin_%28operating_system
%29#Release_history) for Mac - Darwin versions.
...
var isOfMinimumVersion = (minimumVersion) => {
    ...
    for (var i = 0; i < numberOfPieces; i++) {
        ...
        if (typeof actualPiece === 'undefined') {
            ...
            break; // doesn't matter what the next bits are, the            
        } else if (actualPiece === piece) {
